          ...
          <Box>
            <Box marginBottom={4}>
              <Typography variant={'h4'} gutterBottom sx={{ fontWeight: 700 }}>
                  Find important points in seconds
                </Typography>
              <Typography variant={'h6'} color={'text.secondary'}>
              ThereUgo's technology automatically highlights important
contents of the text. It summarizes and then exolain kev
concepts in simple manner. It uses the state of the art
summarization techniques to identify key points using
